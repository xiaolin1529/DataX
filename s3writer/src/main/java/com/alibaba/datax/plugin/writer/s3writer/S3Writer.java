...
public class S3Writer extends Writer {
    ...
    public static class Job extends Writer.Job {
        ...
        public void init() {
            ...
            String endPoint = this.writerSliceConfig.getNecessaryValue(Constant.ENDPOINT, S3ErrorCode.REQUIRED_VALUE);
            String region = this.writerSliceConfig.getNecessaryValue(Constant.REGION, S3ErrorCode.REQUIRED_VALUE);
//            this.s3Client = new AWSExecutor(accessKey,secretKey);
    ...
    public static class Task extends Writer.Task {
        ...
        public void init() {
            ...
            String endPoint = writerSliceConfig.getString(Constant.ENDPOINT);
            String region = writerSliceConfig.getString(Constant.REGION);
