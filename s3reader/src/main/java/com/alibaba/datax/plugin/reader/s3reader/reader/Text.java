...
public class Text implements ReaderBase<String> {
    ...
    private MyCsvReader csvReader = null;
     ...
     * @throws IOException
     */
    private String[] splitBufferedReader(MyCsvReader csvReader) {
    ...
    private void csvReader(){
        this.csvReader = new MyCsvReader(reader);
        this.csvReader.setDelimiter(fieldDelimiter);
